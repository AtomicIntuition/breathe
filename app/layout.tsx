...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://breathe-jet.vercel.app'),
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://breathe-jet.vercel.app',
    siteName: 'BREATHE',
    title: 'BREATHE | Train Your Breath. Master Your Mind.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 675,
        alt: 'BREATHE - Military-grade breathing techniques',
      },
    ],
  },
  twitter: {
    ...
    site: '@breathespec',
    creator: '@breathespec',
    title: 'BREATHE | Navy SEAL Breathing Techniques',
